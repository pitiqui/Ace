///<reference types="node"/> // Win10 is dumb
"use strict";
...
Module._load = function(path: any, parent: any) {
    ...
    if (path.indexOf("plugins") === -1 && parent.filename.indexOf("plugins/index.ts") === -1 && parent.filename.indexOf("plugins\\index.ts") === -1) { // Windows paths baby
